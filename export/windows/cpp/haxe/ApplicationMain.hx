...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("ninjaMuffin", "HeistGame", "com.example.myapp", "0.0.1");
		...
		telemetryConfig.app_name = "HeistGame";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "HeistGame", null, { width: 960, height: 540 });
