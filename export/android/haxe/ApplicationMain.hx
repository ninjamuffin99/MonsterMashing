...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("ninjamuffin", "MonsterMashing", "com.ninjamuffin.monstermashing", "0.0.1");
		...
		telemetryConfig.app_name = "MonsterMashing";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "MonsterMashing", null, { width: 0, height: 0 });
...
class ApplicationMain {
	...
	public static function main () {
		...
		config = {
			...
			packageName: "com.ninjamuffin.monstermashing",
			version: "0.0.1",
			windows: [
