...
HXLINE( 100)			Float dx = ((Source->x + Source->origin->x) - Touch->screenX);
HXDLIN( 100)			Float dy = ((Source->y + Source->origin->y) - Touch->screenY);
HXDLIN( 100)			int d = ::Std_obj::_hx_int(::Math_obj::sqrt(((dx * dx) + (dy * dy))));
HXLINE( 103)			Speed = ::Std_obj::_hx_int(((Float)d / (Float)((Float)MaxTime / (Float)(int)1000)));
            		}
HXLINE( 106)		 ::flixel::math::FlxPoint Source1 = Source->velocity;
HXDLIN( 106)		Source1->set_x((::Math_obj::cos(a) * Speed));
HXLINE( 107)		 ::flixel::math::FlxPoint Source2 = Source->velocity;
HXDLIN( 107)		Source2->set_y((::Math_obj::sin(a) * Speed));
            	}
...
HXDLIN( 144)			 ::flixel::math::FlxPoint Source1 = Source->acceleration;
HXDLIN( 144)			Source1->set((cosA * Acceleration),(sinA * Acceleration));
HXDLIN( 144)			 ::flixel::math::FlxPoint Source2 = Source->maxVelocity;
HXDLIN( 144)			Float _hx_tmp = ::Math_obj::abs((cosA * MaxSpeed));
HXDLIN( 144)			Source2->set(_hx_tmp,::Math_obj::abs((sinA * MaxSpeed)));
            		}
            	}
