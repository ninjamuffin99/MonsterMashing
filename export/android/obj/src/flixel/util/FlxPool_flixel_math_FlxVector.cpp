...
HX_LOCAL_STACK_FRAME(_hx_pos_f5296e3067081a4b_31_get,"flixel.util.FlxPool_flixel_math_FlxVector","get",0xff2ccb9e,"flixel.util.FlxPool_flixel_math_FlxVector.get","flixel/util/FlxPool.hx",31,0xdd4de86a)
HX_LOCAL_STACK_FRAME(_hx_pos_f5296e3067081a4b_42_put,"flixel.util.FlxPool_flixel_math_FlxVector","put",0xff33add7,"flixel.util.FlxPool_flixel_math_FlxVector.put","flixel/util/FlxPool.hx",42,0xdd4de86a)
HX_LOCAL_STACK_FRAME(_hx_pos_f5296e3067081a4b_56_putUnsafe,"flixel.util.FlxPool_flixel_math_FlxVector","putUnsafe",0x73f1215d,"flixel.util.FlxPool_flixel_math_FlxVector.putUnsafe","flixel/util/FlxPool.hx",56,0xdd4de86a)
HX_LOCAL_STACK_FRAME(_hx_pos_f5296e3067081a4b_65_preAllocate,"flixel.util.FlxPool_flixel_math_FlxVector","preAllocate",0x047fdd08,"flixel.util.FlxPool_flixel_math_FlxVector.preAllocate","flixel/util/FlxPool.hx",65,0xdd4de86a)
HX_LOCAL_STACK_FRAME(_hx_pos_f5296e3067081a4b_72_clear,"flixel.util.FlxPool_flixel_math_FlxVector","clear",0x73a88e95,"flixel.util.FlxPool_flixel_math_FlxVector.clear","flixel/util/FlxPool.hx",72,0xdd4de86a)
HX_LOCAL_STACK_FRAME(_hx_pos_f5296e3067081a4b_81_get_length,"flixel.util.FlxPool_flixel_math_FlxVector","get_length",0xd973aaa7,"flixel.util.FlxPool_flixel_math_FlxVector.get_length","flixel/util/FlxPool.hx",81,0xdd4de86a)
namespace flixel{
namespace util{
...
HXDLIN(  36)		return _hx_tmp->__get(--this->_count).StaticCast<  ::flixel::math::FlxVector >();
            	}
...
HXDLIN(  67)			_hx_tmp[_hx_tmp1] = ( ( ::flixel::math::FlxVector)(::Type_obj::createInstance(this->_class,::cpp::VirtualArray_obj::__new(0))) );
            		}
            		_hx_goto_4:;
            	}
