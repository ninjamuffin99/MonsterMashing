...
HXLINE(  36)		::cpp::VirtualArray _hx_tmp = this->_pool;
HXDLIN(  36)		return _hx_tmp->__get(--this->_count);
            	}
...
HXLINE(  49)				::cpp::VirtualArray _hx_tmp1 = this->_pool;
HXDLIN(  49)				_hx_tmp1->set(this->_count++,obj);
            			}
            		}
            	}
...
HXLINE(  59)			::cpp::VirtualArray _hx_tmp = this->_pool;
HXDLIN(  59)			_hx_tmp->set(this->_count++,obj);
            		}
            	}
...
HXLINE(  67)			::cpp::VirtualArray _hx_tmp = this->_pool;
HXDLIN(  67)			int _hx_tmp1 = this->_count++;
HXDLIN(  67)			_hx_tmp->set(_hx_tmp1,::Type_obj::createInstance(this->_class,::cpp::VirtualArray_obj::__new(0)));
            		}
            		_hx_goto_4:;
            	}
...
{
	hx::Object *dummy = new FlxPool_obj;
	FlxPool_obj::_hx_vtable = *(void **)dummy;
