...
HXDLIN(  36)		return _hx_tmp->__get(--this->_count).StaticCast<  ::flixel::effects::FlxFlicker >();
            	}
...
HXDLIN(  67)			_hx_tmp[_hx_tmp1] = ( ( ::flixel::effects::FlxFlicker)(::Type_obj::createInstance(this->_class,::cpp::VirtualArray_obj::__new(0))) );
            		}
            		_hx_goto_4:;
            	}
