...
::Array< ::Dynamic> Tooltip_obj::_tooltips;
 ...
 ::openfl::_legacy::display::Sprite Tooltip_obj::_container;

void Tooltip_obj::init( ::openfl::_legacy::display::Sprite container){
...
void Tooltip_obj::add( ::openfl::_legacy::display::Sprite element,::String text){
...
bool Tooltip_obj::remove( ::openfl::_legacy::display::Sprite element){
...
bool Tooltip_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,hx::PropertyAccess inCallProp)
{
	...
	case 9:
		...
		break;
	case 10:
		if (HX_FIELD_EQ(inName,"_container") ) { _container=ioValue.Cast<  ::openfl::_legacy::display::Sprite >(); return true; }
	}
	return false;
}
...
static hx::StaticInfo Tooltip_obj_sStaticStorageInfo[] = {
	...
	{hx::fsObject /*::openfl::_legacy::display::Sprite*/ ,(void *) &Tooltip_obj::_container,HX_HCSTRING("_container","\x02","\xf1","\x15","\x1b")},
	{ hx::fsUnknown, 0, null()}
};
#endif
