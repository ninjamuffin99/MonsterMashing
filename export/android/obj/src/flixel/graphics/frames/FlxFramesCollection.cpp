...
HX_LOCAL_STACK_FRAME(_hx_pos_8894dc9191d7a9ff_254_get_numFrames,"flixel.graphics.frames.FlxFramesCollection","get_numFrames",0xbd2728b4,"flixel.graphics.frames.FlxFramesCollection.get_numFrames","flixel/graphics/frames/FlxFramesCollection.hx",254,0xe09dd200)
namespace flixel{
namespace graphics{
namespace frames{
...
HXLINE( 248)		 ::Dynamic value = this->frames;
HXDLIN( 248)		 ::flixel::util::LabelValuePair _this = ::flixel::util::LabelValuePair_obj::_pool->get();
HXDLIN( 248)		_this->label = HX_("frames",a6,af,85,ac);
HXDLIN( 248)		_this->value = value;
HXDLIN( 248)		 ::flixel::util::LabelValuePair _hx_tmp = _this;
HXLINE( 249)		 ::Dynamic value1 = this->type;
HXDLIN( 249)		 ::flixel::util::LabelValuePair _this1 = ::flixel::util::LabelValuePair_obj::_pool->get();
HXDLIN( 249)		_this1->label = HX_("type",ba,f2,08,4d);
HXDLIN( 249)		_this1->value = value1;
HXLINE( 247)		return ::flixel::util::FlxStringUtil_obj::getDebugString(::Array_obj< ::Dynamic>::__new(2)->init(0,_hx_tmp)->init(1,_this1));
            	}
...
int FlxFramesCollection_obj::get_numFrames(){
            	HX_STACKFRAME(&_hx_pos_8894dc9191d7a9ff_254_get_numFrames)
HXDLIN( 254)		return this->frames->length;
            	}
