...
HX_LOCAL_STACK_FRAME(_hx_pos_cea460118c4fe0d4_72_isAxisFlipped,"flixel.input.gamepad.mappings.PSVitaMapping","isAxisFlipped",0x43decece,"flixel.input.gamepad.mappings.PSVitaMapping.isAxisFlipped","flixel/input/gamepad/mappings/PSVitaMapping.hx",72,0xe1b17b97)
namespace flixel{
namespace input{
namespace gamepad{
namespace mappings{
...
HXDLIN(  72)		if ((axisID != ::flixel::input::gamepad::id::PSVitaID_obj::LEFT_ANALOG_STICK->y)) {
