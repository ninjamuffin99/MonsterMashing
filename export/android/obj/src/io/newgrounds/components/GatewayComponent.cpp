...
bool GatewayComponent_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x59520321) {
		return inClassId==(int)0x00000001 || inClassId==(int)0x59520321;
	} else {
...
static ::String GatewayComponent_obj_sMemberFields[] = {
	HX_HCSTRING("getDatetime","\xf1","\x93","\x25","\x15"),
	HX_HCSTRING("getVersion","\x22","\x6d","\x53","\xcc"),
	HX_HCSTRING("ping","\x72","\xf2","\x57","\x4a"),
	::String(null()) };

static void GatewayComponent_obj_sMarkStatics(HX_MARK_PARAMS) {
	HX_MARK_MEMBER_NAME(GatewayComponent_obj::__mClass,"__mClass");
};

#ifdef HXCPP_VISIT_ALLOCS
static void GatewayComponent_obj_sVisitStatics(HX_VISIT_PARAMS) {
	HX_VISIT_MEMBER_NAME(GatewayComponent_obj::__mClass,"__mClass");
};
...
{
	hx::Object *dummy = new GatewayComponent_obj;
	GatewayComponent_obj::_hx_vtable = *(void **)dummy;
	hx::Static(__mClass) = new hx::Class_obj();
	__mClass->mName = HX_HCSTRING("io.newgrounds.components.GatewayComponent","\x57","\xae","\x40","\xa7");
	__mClass->mSuper = &super::__SGetClass();
	__mClass->mConstructEmpty = &__CreateEmpty;
	__mClass->mConstructArgs = &__Create;
	__mClass->mGetStaticField = &hx::Class_obj::GetNoStaticField;
	__mClass->mSetStaticField = &hx::Class_obj::SetNoStaticField;
	__mClass->mMarkFunc = GatewayComponent_obj_sMarkStatics;
...
#ifdef HXCPP_VISIT_ALLOCS
	__mClass->mVisitFunc = GatewayComponent_obj_sVisitStatics;
#endif
