...
bool AppComponent_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x577d26e4) {
		return inClassId==(int)0x00000001 || inClassId==(int)0x577d26e4;
	} else {
...
static ::String AppComponent_obj_sMemberFields[] = {
	HX_HCSTRING("startSession","\x14","\xfb","\x43","\x05"),
	HX_HCSTRING("checkSession","\x6e","\xcf","\x1e","\x81"),
	HX_HCSTRING("endSession","\xbb","\x3c","\xba","\x39"),
	HX_HCSTRING("getCurrentVersion","\x15","\x0b","\xfa","\xfc"),
	HX_HCSTRING("getHostLicense","\x03","\xbc","\x2b","\x87"),
	HX_HCSTRING("logView","\x09","\x45","\x19","\x74"),
	::String(null()) };

static void AppComponent_obj_sMarkStatics(HX_MARK_PARAMS) {
	HX_MARK_MEMBER_NAME(AppComponent_obj::__mClass,"__mClass");
};

#ifdef HXCPP_VISIT_ALLOCS
static void AppComponent_obj_sVisitStatics(HX_VISIT_PARAMS) {
	HX_VISIT_MEMBER_NAME(AppComponent_obj::__mClass,"__mClass");
};
...
{
	hx::Object *dummy = new AppComponent_obj;
	AppComponent_obj::_hx_vtable = *(void **)dummy;
	hx::Static(__mClass) = new hx::Class_obj();
	__mClass->mName = HX_HCSTRING("io.newgrounds.components.AppComponent","\x1a","\x7f","\x3c","\xff");
	__mClass->mSuper = &super::__SGetClass();
	__mClass->mConstructEmpty = &__CreateEmpty;
	__mClass->mConstructArgs = &__Create;
	__mClass->mGetStaticField = &hx::Class_obj::GetNoStaticField;
	__mClass->mSetStaticField = &hx::Class_obj::SetNoStaticField;
	__mClass->mMarkFunc = AppComponent_obj_sMarkStatics;
...
#ifdef HXCPP_VISIT_ALLOCS
	__mClass->mVisitFunc = AppComponent_obj_sVisitStatics;
#endif
