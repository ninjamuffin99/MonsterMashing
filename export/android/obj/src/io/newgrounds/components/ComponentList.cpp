...
bool ComponentList_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x378a93b3;
}
...
void ComponentList_obj::__GetFields(Array< ::String> &outFields)
{
	...
	outFields->push(HX_HCSTRING("medal","\xf7","\xfd","\xbb","\x05"));
	...
	outFields->push(HX_HCSTRING("gateway","\x04","\x40","\x59","\x91"));
	super::__GetFields(outFields);
};

#if HXCPP_SCRIPTABLE
static hx::StorageInfo ComponentList_obj_sMemberStorageInfo[] = {
	{hx::fsObject /*::io::newgrounds::NGLite*/ ,(int)offsetof(ComponentList_obj,_core),HX_HCSTRING("_core","\x3e","\xd9","\xd5","\xf4")},
	{hx::fsObject /*::io::newgrounds::components::MedalComponent*/ ,(int)offsetof(ComponentList_obj,medal),HX_HCSTRING("medal","\xf7","\xfd","\xbb","\x05")},
	{hx::fsObject /*::io::newgrounds::components::AppComponent*/ ,(int)offsetof(ComponentList_obj,app),HX_HCSTRING("app","\xa1","\xfc","\x49","\x00")},
	{hx::fsObject /*::io::newgrounds::components::EventComponent*/ ,(int)offsetof(ComponentList_obj,event),HX_HCSTRING("event","\x1a","\xc8","\xc4","\x75")},
	{hx::fsObject /*::io::newgrounds::components::ScoreBoardComponent*/ ,(int)offsetof(ComponentList_obj,scoreBoard),HX_HCSTRING("scoreBoard","\xf4","\x39","\x64","\xf2")},
	{hx::fsObject /*::io::newgrounds::components::LoaderComponent*/ ,(int)offsetof(ComponentList_obj,loader),HX_HCSTRING("loader","\x13","\x48","\x6f","\x58")},
	{hx::fsObject /*::io::newgrounds::components::GatewayComponent*/ ,(int)offsetof(ComponentList_obj,gateway),HX_HCSTRING("gateway","\x04","\x40","\x59","\x91")},
	{ hx::fsUnknown, 0, null()}
};
...
static ::String ComponentList_obj_sMemberFields[] = {
	...
	HX_HCSTRING("medal","\xf7","\xfd","\xbb","\x05"),
	...
	HX_HCSTRING("gateway","\x04","\x40","\x59","\x91"),
	::String(null()) };

static void ComponentList_obj_sMarkStatics(HX_MARK_PARAMS) {
	HX_MARK_MEMBER_NAME(ComponentList_obj::__mClass,"__mClass");
};

#ifdef HXCPP_VISIT_ALLOCS
static void ComponentList_obj_sVisitStatics(HX_VISIT_PARAMS) {
	HX_VISIT_MEMBER_NAME(ComponentList_obj::__mClass,"__mClass");
};
...
{
	hx::Object *dummy = new ComponentList_obj;
	ComponentList_obj::_hx_vtable = *(void **)dummy;
	hx::Static(__mClass) = new hx::Class_obj();
	__mClass->mName = HX_HCSTRING("io.newgrounds.components.ComponentList","\xbd","\x6a","\x38","\x57");
	__mClass->mSuper = &super::__SGetClass();
	__mClass->mConstructEmpty = &__CreateEmpty;
	__mClass->mConstructArgs = &__Create;
	__mClass->mGetStaticField = &hx::Class_obj::GetNoStaticField;
	__mClass->mSetStaticField = &hx::Class_obj::SetNoStaticField;
	__mClass->mMarkFunc = ComponentList_obj_sMarkStatics;
...
#ifdef HXCPP_VISIT_ALLOCS
	__mClass->mVisitFunc = ComponentList_obj_sVisitStatics;
#endif
