...
bool LoaderComponent_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x218d985a) {
		return inClassId==(int)0x00000001 || inClassId==(int)0x218d985a;
	} else {
...
static ::String LoaderComponent_obj_sMemberFields[] = {
	HX_HCSTRING("loadAuthorUrl","\x9e","\xb2","\xd9","\x35"),
	HX_HCSTRING("loadMoreGames","\x66","\x45","\x8d","\x28"),
	HX_HCSTRING("loadNewgrounds","\x72","\x19","\x58","\x8d"),
	HX_HCSTRING("loadOfficialUrl","\x7e","\x6f","\xfc","\x75"),
	HX_HCSTRING("loadReferral","\xa3","\x25","\x68","\xd5"),
	::String(null()) };

static void LoaderComponent_obj_sMarkStatics(HX_MARK_PARAMS) {
	HX_MARK_MEMBER_NAME(LoaderComponent_obj::__mClass,"__mClass");
};

#ifdef HXCPP_VISIT_ALLOCS
static void LoaderComponent_obj_sVisitStatics(HX_VISIT_PARAMS) {
	HX_VISIT_MEMBER_NAME(LoaderComponent_obj::__mClass,"__mClass");
};
...
{
	hx::Object *dummy = new LoaderComponent_obj;
	LoaderComponent_obj::_hx_vtable = *(void **)dummy;
	hx::Static(__mClass) = new hx::Class_obj();
	__mClass->mName = HX_HCSTRING("io.newgrounds.components.LoaderComponent","\xac","\x41","\x7d","\xa9");
	__mClass->mSuper = &super::__SGetClass();
	__mClass->mConstructEmpty = &__CreateEmpty;
	__mClass->mConstructArgs = &__Create;
	__mClass->mGetStaticField = &hx::Class_obj::GetNoStaticField;
	__mClass->mSetStaticField = &hx::Class_obj::SetNoStaticField;
	__mClass->mMarkFunc = LoaderComponent_obj_sMarkStatics;
...
#ifdef HXCPP_VISIT_ALLOCS
	__mClass->mVisitFunc = LoaderComponent_obj_sVisitStatics;
#endif
