...
HX_LOCAL_STACK_FRAME(_hx_pos_b6a816ce58d91dc4_231_toString,"haxe.CallStack","toString",0xd59be738,"haxe.CallStack.toString","C:\\HaxeToolkit\\haxe\\std/haxe/CallStack.hx",231,0xf338fe24)
static const ::String _hx_array_data_6d544b62_2[] = {
	HX_("\nCalled from ",bd,26,6b,81),
};
HX_LOCAL_STACK_FRAME(_hx_pos_b6a816ce58d91dc4_241_itemToString,"haxe.CallStack","itemToString",0xc121696b,"haxe.CallStack.itemToString","C:\\HaxeToolkit\\haxe\\std/haxe/CallStack.hx",241,0xf338fe24)
...
::String CallStack_obj::toString(::Array< ::Dynamic> stack){
            	HX_GC_STACKFRAME(&_hx_pos_b6a816ce58d91dc4_231_toString)
...
void CallStack_obj::itemToString( ::StringBuf b, ::haxe::StackItem s){
            	HX_STACKFRAME(&_hx_pos_b6a816ce58d91dc4_241_itemToString)
