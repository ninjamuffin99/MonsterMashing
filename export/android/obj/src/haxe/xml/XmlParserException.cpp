...
HX_DEFINE_STACK_FRAME(_hx_pos_bc1e3a125215c6c2_77_new,"haxe.xml.XmlParserException","new",0xcd6fdfea,"haxe.xml.XmlParserException.new","C:\\HaxeToolkit\\haxe\\std/haxe/xml/Parser.hx",77,0xbc28dcd7)
HX_LOCAL_STACK_FRAME(_hx_pos_bc1e3a125215c6c2_98_toString,"haxe.xml.XmlParserException","toString",0xed7c2ce2,"haxe.xml.XmlParserException.toString","C:\\HaxeToolkit\\haxe\\std/haxe/xml/Parser.hx",98,0xbc28dcd7)
namespace haxe{
namespace xml{

void XmlParserException_obj::__construct(::String message,::String xml,int position){
            	HX_STACKFRAME(&_hx_pos_bc1e3a125215c6c2_77_new)
...
::String XmlParserException_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_bc1e3a125215c6c2_98_toString)
