...
HX_LOCAL_STACK_FRAME(_hx_pos_4d07261a8c083a23_38_sendMessage,"cpp.vm.Thread","sendMessage",0x48dced27,"cpp.vm.Thread.sendMessage","C:\\HaxeToolkit\\haxe\\std/cpp/vm/Thread.hx",38,0xd8d7e381)
...
HX_LOCAL_STACK_FRAME(_hx_pos_4d07261a8c083a23_46_current,"cpp.vm.Thread","current",0x21a37c01,"cpp.vm.Thread.current","C:\\HaxeToolkit\\haxe\\std/cpp/vm/Thread.hx",46,0xd8d7e381)
...
HX_LOCAL_STACK_FRAME(_hx_pos_4d07261a8c083a23_62_readMessage,"cpp.vm.Thread","readMessage",0x11bc2cd9,"cpp.vm.Thread.readMessage","C:\\HaxeToolkit\\haxe\\std/cpp/vm/Thread.hx",62,0xd8d7e381)
namespace cpp{
namespace vm{
...
void Thread_obj::sendMessage( ::Dynamic msg){
            	HX_STACKFRAME(&_hx_pos_4d07261a8c083a23_38_sendMessage)
...
HX_DEFINE_DYNAMIC_FUNC1(Thread_obj,__compare,return )
 ...
 ::cpp::vm::Thread Thread_obj::current(){
            	HX_GC_STACKFRAME(&_hx_pos_4d07261a8c083a23_46_current)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Thread_obj,create,return )
 ...
 ::Dynamic Thread_obj::readMessage(bool block){
            	HX_STACKFRAME(&_hx_pos_4d07261a8c083a23_62_readMessage)
