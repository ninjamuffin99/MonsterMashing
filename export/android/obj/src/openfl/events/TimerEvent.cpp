...
HX_LOCAL_STACK_FRAME(_hx_pos_8ee12f816d5b32f3_33_toString,"openfl.events.TimerEvent","toString",0x793b7c4e,"openfl.events.TimerEvent.toString","openfl/events/TimerEvent.hx",33,0x5c7b7b12)
static const ::String _hx_array_data_7c93b10c_3[] = {
	HX_("type",ba,f2,08,4d),HX_("bubbles",67,bb,56,61),HX_("cancelable",14,a0,79,c4),
};
HX_LOCAL_STACK_FRAME(_hx_pos_8ee12f816d5b32f3_38_updateAfterEvent,"openfl.events.TimerEvent","updateAfterEvent",0xcd7c1969,"openfl.events.TimerEvent.updateAfterEvent","openfl/events/TimerEvent.hx",38,0x5c7b7b12)
...
bool TimerEvent_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::_legacy::events::Event TimerEvent_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_8ee12f816d5b32f3_18_clone)
HXLINE(  20)		::String event = this->get_type();
HXDLIN(  20)		bool event1 = this->get_bubbles();
HXDLIN(  20)		 ::openfl::events::TimerEvent event2 =  ::openfl::events::TimerEvent_obj::__alloc( HX_CTX ,event,event1,this->get_cancelable());
HXLINE(  21)		event2->set_target(this->get_target());
HXLINE(  22)		event2->set_currentTarget(this->get_currentTarget());
HXLINE(  26)		return event2;
            	}


::String TimerEvent_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_8ee12f816d5b32f3_33_toString)
HXDLIN(  33)		return this->_hx___formatToString(HX_("TimerEvent",35,32,87,fd),::Array_obj< ::String >::fromData( _hx_array_data_7c93b10c_3,3));
            	}


void TimerEvent_obj::updateAfterEvent(){
            	HX_STACKFRAME(&_hx_pos_8ee12f816d5b32f3_38_updateAfterEvent)
            	}
