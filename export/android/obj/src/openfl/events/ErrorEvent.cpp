...
HX_LOCAL_STACK_FRAME(_hx_pos_0aefc26d1b1b4062_35_toString,"openfl.events.ErrorEvent","toString",0x299f6791,"openfl.events.ErrorEvent.toString","openfl/events/ErrorEvent.hx",35,0x9d2fc215)
...
HXLINE(  22)		::String event = this->get_type();
HXDLIN(  22)		bool event1 = this->get_bubbles();
HXDLIN(  22)		bool event2 = this->get_cancelable();
HXDLIN(  22)		 ::openfl::events::ErrorEvent event3 =  ::openfl::events::ErrorEvent_obj::__alloc( HX_CTX ,event,event1,event2,this->text,this->errorID);
HXLINE(  23)		event3->set_target(this->get_target());
HXLINE(  24)		event3->set_currentTarget(this->get_currentTarget());
HXLINE(  28)		return event3;
            	}


::String ErrorEvent_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_0aefc26d1b1b4062_35_toString)
HXDLIN(  35)		return this->_hx___formatToString(HX_("ErrorEvent",52,bb,79,e1),::Array_obj< ::String >::fromData( _hx_array_data_60863a29_3,5));
            	}
