...
class HXCPP_CLASS_ATTRIBUTES FlxVersion_obj : public hx::Object
{
	...
	public:
		...
		hx::ObjectPtr< FlxVersion_obj > __new(int Major,int Minor,int Patch) {
			hx::ObjectPtr< FlxVersion_obj > __this = new FlxVersion_obj();
			__this->__construct(Major,Minor,Patch);
			return __this;
		}

		static hx::ObjectPtr< FlxVersion_obj > __alloc(hx::Ctx *_hx_ctx,int Major,int Minor,int Patch) {
