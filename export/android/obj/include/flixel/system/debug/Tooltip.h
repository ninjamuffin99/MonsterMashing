...
class HXCPP_CLASS_ATTRIBUTES Tooltip_obj : public hx::Object
{
	...
	public:
		...
		static  ::openfl::_legacy::display::Sprite _container;
		static void init( ::openfl::_legacy::display::Sprite container);
		static ::Dynamic init_dyn();

		static void add( ::openfl::_legacy::display::Sprite element,::String text);
		static ::Dynamic add_dyn();

		static bool remove( ::openfl::_legacy::display::Sprite element);
