...
HX_DECLARE_STACK_FRAME(_hx_pos_4946e010770d7497_52_new)
...
HXLINE(  53)		( ( ::flixel::_hx_system::debug::log::LogStyle)(__this) )->prefix = Prefix;
HXLINE(  54)		( ( ::flixel::_hx_system::debug::log::LogStyle)(__this) )->color = Color;
HXLINE(  55)		( ( ::flixel::_hx_system::debug::log::LogStyle)(__this) )->size = Size;
HXLINE(  56)		( ( ::flixel::_hx_system::debug::log::LogStyle)(__this) )->bold = Bold;
HXLINE(  57)		( ( ::flixel::_hx_system::debug::log::LogStyle)(__this) )->italic = Italic;
HXLINE(  58)		( ( ::flixel::_hx_system::debug::log::LogStyle)(__this) )->underlined = Underlined;
HXLINE(  59)		( ( ::flixel::_hx_system::debug::log::LogStyle)(__this) )->errorSound = ErrorSound;
HXLINE(  60)		( ( ::flixel::_hx_system::debug::log::LogStyle)(__this) )->openConsole = OpenConsole;
HXLINE(  61)		( ( ::flixel::_hx_system::debug::log::LogStyle)(__this) )->callbackFunction = CallbackFunction;
            	}
