...
class HXCPP_CLASS_ATTRIBUTES Interaction_obj : public  ::flixel::_hx_system::debug::Window_obj
{
	...
	public:
		...
		static hx::ObjectPtr< Interaction_obj > __alloc(hx::Ctx *_hx_ctx, ::openfl::_legacy::display::Sprite container);
		...
		bool belongsToDebugger( ::openfl::_legacy::display::DisplayObject object);
