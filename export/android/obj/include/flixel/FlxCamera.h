...
class HXCPP_CLASS_ATTRIBUTES FlxCamera_obj : public  ::flixel::FlxBasic_obj
{
	...
	public:
		...
		Float initialZoom;
		 ...
		 ::flixel::graphics::tile::FlxDrawTilesItem startQuadBatch( ::flixel::graphics::FlxGraphic graphic,bool colored,hx::Null< bool >  hasColorOffsets, ::openfl::_legacy::display::BlendMode blend,hx::Null< bool >  smooth, ::Dynamic shader);
		::Dynamic startQuadBatch_dyn();

		 ::flixel::graphics::tile::FlxDrawTrianglesItem startTrianglesBatch( ::flixel::graphics::FlxGraphic graphic,hx::Null< bool >  smoothing,hx::Null< bool >  isColored, ::openfl::_legacy::display::BlendMode blend);
		::Dynamic startTrianglesBatch_dyn();

		 ::flixel::graphics::tile::FlxDrawTrianglesItem getNewDrawTrianglesItem( ::flixel::graphics::FlxGraphic graphic,hx::Null< bool >  smoothing,hx::Null< bool >  isColored, ::openfl::_legacy::display::BlendMode blend);
		...
		void drawPixels( ::flixel::graphics::frames::FlxFrame frame, ::openfl::_legacy::display::BitmapData pixels, ::flixel::math::FlxMatrix matrix, ::openfl::_legacy::geom::ColorTransform transform, ::openfl::_legacy::display::BlendMode blend, ::Dynamic smoothing, ::Dynamic shader);
		::Dynamic drawPixels_dyn();

		void copyPixels( ::flixel::graphics::frames::FlxFrame frame, ::openfl::_legacy::display::BitmapData pixels, ::openfl::_legacy::geom::Rectangle sourceRect, ::openfl::_legacy::geom::Point destPoint, ::openfl::_legacy::geom::ColorTransform transform, ::openfl::_legacy::display::BlendMode blend, ::Dynamic smoothing, ::Dynamic shader);
		::Dynamic copyPixels_dyn();

		void drawTriangles( ::flixel::graphics::FlxGraphic graphic,::Array< Float > vertices,::Array< int > indices,::Array< Float > uvtData,::Array< int > colors, ::flixel::math::FlxPoint position, ::openfl::_legacy::display::BlendMode blend,hx::Null< bool >  repeat,hx::Null< bool >  smoothing);
		...
		::Dynamic transformVector_dyn();
		 ...
		 ::openfl::_legacy::display::DisplayObject transformObject( ::openfl::_legacy::display::DisplayObject object);
