...
class HXCPP_CLASS_ATTRIBUTES FlxG_obj : public hx::Object
{
	...
	public:
		...
		static void __boot();
		static  ::openfl::_legacy::text::TextField removeChild_openfl__legacy_text_TextField( ::openfl::_legacy::text::TextField Child);
		static ::Dynamic removeChild_openfl__legacy_text_TextField_dyn();
