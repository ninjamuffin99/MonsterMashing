...
class HXCPP_CLASS_ATTRIBUTES FlxTouchManager_obj : public hx::Object
{
	...
	public:
		...
		void handleTouchBegin( ::openfl::_legacy::events::TouchEvent FlashEvent);
		::Dynamic handleTouchBegin_dyn();

		void handleTouchEnd( ::openfl::_legacy::events::TouchEvent FlashEvent);
		::Dynamic handleTouchEnd_dyn();

		void handleTouchMove( ::openfl::_legacy::events::TouchEvent FlashEvent);
