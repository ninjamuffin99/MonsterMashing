...
class HXCPP_CLASS_ATTRIBUTES FocusEvent_obj : public  ::openfl::_legacy::events::Event_obj
{
	...
	public:
		...
		static hx::ObjectPtr< FocusEvent_obj > __alloc(hx::Ctx *_hx_ctx,::String type,hx::Null< bool >  __o_bubbles,hx::Null< bool >  __o_cancelable, ::openfl::_legacy::display::InteractiveObject relatedObject,hx::Null< bool >  __o_shiftKey,hx::Null< int >  __o_keyCode);
