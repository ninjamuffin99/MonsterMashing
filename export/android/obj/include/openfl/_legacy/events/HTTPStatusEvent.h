...
class HXCPP_CLASS_ATTRIBUTES HTTPStatusEvent_obj : public  ::openfl::_legacy::events::Event_obj
{
	...
	public:
		...
		static hx::ObjectPtr< HTTPStatusEvent_obj > __alloc(hx::Ctx *_hx_ctx,::String type,hx::Null< bool >  __o_bubbles,hx::Null< bool >  __o_cancelable,hx::Null< int >  __o_status);
