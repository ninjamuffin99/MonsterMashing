...
class HXCPP_CLASS_ATTRIBUTES TypedDispatcher_obj : public hx::Object
{
	...
	public:
		...
		hx::ObjectPtr< TypedDispatcher_obj > __new() {
			hx::ObjectPtr< TypedDispatcher_obj > __this = new TypedDispatcher_obj();
			__this->__construct();
			return __this;
		}

		static hx::ObjectPtr< TypedDispatcher_obj > __alloc(hx::Ctx *_hx_ctx) {
...
HXLINE(  71)		( ( ::io::newgrounds::utils::TypedDispatcher)(__this) )->_once = ::Array_obj< ::Dynamic>::__new();
		...
		::String __ToString() const { return HX_HCSTRING("TypedDispatcher","\x91","\xae","\xcd","\x02"); }
