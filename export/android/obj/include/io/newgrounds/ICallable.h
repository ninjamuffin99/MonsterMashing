...
class HXCPP_CLASS_ATTRIBUTES ICallable_obj {
	public:
		...
		static inline void send( ::Dynamic _hx_) {
			(_hx_.mPtr->*( static_cast< ::io::newgrounds::ICallable_obj *>(_hx_.mPtr->_hx_getInterface(0xda87fdcf)))->_hx_send)();
		}
		void (hx::Object :: *_hx_queue)(); 
		static inline void queue( ::Dynamic _hx_) {
			(_hx_.mPtr->*( static_cast< ::io::newgrounds::ICallable_obj *>(_hx_.mPtr->_hx_getInterface(0xda87fdcf)))->_hx_queue)();
		}
		void (hx::Object :: *_hx_destroy)(); 
		static inline void destroy( ::Dynamic _hx_) {
			(_hx_.mPtr->*( static_cast< ::io::newgrounds::ICallable_obj *>(_hx_.mPtr->_hx_getInterface(0xda87fdcf)))->_hx_destroy)();
		}
};
