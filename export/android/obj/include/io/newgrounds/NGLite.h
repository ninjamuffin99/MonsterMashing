...
class HXCPP_CLASS_ATTRIBUTES NGLite_obj : public hx::Object
{
	...
	public:
		...
		static hx::ObjectPtr< NGLite_obj > __new(::String __o_appId,::String sessionId);
		static hx::ObjectPtr< NGLite_obj > __alloc(hx::Ctx *_hx_ctx,::String __o_appId,::String sessionId);
		...
		::String __ToString() const { return HX_HCSTRING("NGLite","\x07","\x9e","\xd5","\x43"); }
		...
		virtual void checkInitialSession( ::io::newgrounds::objects::events::Response response);
