...
HX_DECLARE_STACK_FRAME(_hx_pos_c2e5bb5e77faa47a_12_new)
...
class HXCPP_CLASS_ATTRIBUTES Key_obj : public hx::Object
{
	...
	public:
		...
		hx::ObjectPtr< Key_obj > __new( ::Dynamic k) {
			hx::ObjectPtr< Key_obj > __this = new Key_obj();
			__this->__construct(k);
			return __this;
		}

		static hx::ObjectPtr< Key_obj > __alloc(hx::Ctx *_hx_ctx, ::Dynamic k) {
...
HXDLIN(  12)		( ( ::sys::ssl::Key)(__this) )->_hx___k = k;
            	}
