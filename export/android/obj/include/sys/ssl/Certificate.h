...
HX_DECLARE_STACK_FRAME(_hx_pos_3f9d4c8ba0b22226_11_new)
...
class HXCPP_CLASS_ATTRIBUTES Certificate_obj : public hx::Object
{
	...
	public:
		...
		hx::ObjectPtr< Certificate_obj > __new( ::Dynamic x, ::sys::ssl::Certificate h) {
...
HXLINE(  12)		( ( ::sys::ssl::Certificate)(__this) )->_hx___x = x;
HXLINE(  13)		( ( ::sys::ssl::Certificate)(__this) )->_hx___h = h;
            	}
