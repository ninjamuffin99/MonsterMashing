...
class BoxFader extends FlxSprite
{
	 ...
	 * @param	callback
	 */
	public function fadeColor(Color:Int = 0xFF000000, ?P:Dynamic, ?Callback:Dynamic)
	{
		P = DataTool.copyFieldsC(P, {
			time:FADE_TIME,
			steps:FADE_STEPS,
	...
	public function _timerHardStep(totalTime:Float, start:Float, end:Float, steps:Int, ?callback:Void->Void, delayCall:Float = 0)
	{
